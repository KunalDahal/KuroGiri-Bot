...
class Bot(Client):
    ...
    async def start(self):
        ...
        self.CHANNEL_LIST = await ocean.get_all_channels()
        self.REQFSUB = await ocean.get_request_forcesub()
        
        self.LOGGER(__name__).info(f"Aᴅᴠᴀɴᴄᴇ Fɪʟᴇ-Sʜᴀʀɪɴɢ ʙᴏᴛV3 Mᴀᴅᴇ Bʏ ➪ @OceanXBotz")
